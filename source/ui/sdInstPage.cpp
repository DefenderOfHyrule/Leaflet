...
namespace inst::ui {
    ...
    sdInstPage::sdInstPage() : Layout::Layout() {
        ...
        this->statusBar = StatusBar::New(StatusBar::Mode::Full, "main.menu.sd"_lang); this->statusBar->Attach(this);
    ...
    void sdInstPage::onInput(u64 Down, u64 Up, u64 Held, pu::ui::Touch Pos) {
        ...
        if (Down & HidNpadButton_ZL) {
            int selectedIndex = this->menu->GetSelectedIndex();
            int dirOffset = (this->currentDir != "sdmc:/") ? 1 : 0;
            ...
            if (isFolder) {
                ...
                int confirmResult = mainApp->CreateShowDialog("inst.archivebit.confirm_title"_lang, confirmDesc, {"common.ok"_lang, "common.cancel"_lang}, true);
                if (confirmResult == 0) {
