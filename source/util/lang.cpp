...
namespace Language {
    ...
    void Load() {
        ...
        switch (langInt) {
            ...
            case SetLanguage_ZHHANS:
                ...
                // use a font that covers simplified Chinese characters.
            ...
            case SetLanguage_ZHTW:
                ...
                // use a font that covers traditional Chinese characters.
    ...
    std::vector<std::string> LanguageArray(std::string key) {
        ...
        if (j == nullptr || !j.is_array()) return result;
        for (const auto& entry : j) result.push_back(entry.get<std::string>());
        return result;
    }
