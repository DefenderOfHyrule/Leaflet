...
TARGET		:=	leaflet
BUILD		:=	build
SOURCES		:=	source source/ui source/data source/install source/nx source/nx/ipc source/util source/quark external/libhaze/source \
			...
			external/goldleaf-usb/source/usb external/goldleaf-usb/source/usb/cmd external/goldleaf-usb/source/fs
DATA		:=	data
INCLUDES	:=	include/libusbhsfs/include include include/ui include/data include/install include/nx include/nx/ipc include/util \
				include/quark \
				include/libusbhsfs/source \
				external/goldleaf-usb/include \
...
LIBS	+=	-lmbedtls -lmbedcrypto -lminizip -lzstd -lz # Memes
