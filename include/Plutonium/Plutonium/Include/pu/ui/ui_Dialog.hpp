...
namespace pu::ui
{
    class Dialog
    {
        public:
            ...
            static void SetDefaultColors(const Color& Background, const Color& Border, const Color& Accent);
        private:
            static Color s_defaultBackground;
            static Color s_defaultBorder;
            static Color s_defaultAccent;
